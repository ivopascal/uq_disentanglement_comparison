...
def ood_class_detection(dataset_name, config):
    ...
    for architecture in architectures:
        ...
        disentangle_model = train_gaussian_logits_model(architecture.model_function, X_train_id, y_train_id, n_classes,
                                                        epochs=epochs)
        entropy_model = train_it_model(architecture.model_function, X_train_id, y_train_id, n_classes, epochs=epochs)
